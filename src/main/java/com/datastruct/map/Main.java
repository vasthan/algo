...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> words1 = FileOperation.readFileToWords("src/main/resources/pride-and-prejudice.txt");
        ...
        List<String> words2 = FileOperation.readFileToWords("src/main/resources/pride-and-prejudice.txt");
